...
class FixedMassEnvironment:
    ...
    def calculate_reward(self, state, extra_reward=0):
        ...
        x_position_reward_weight = 130
        y_position_reward_weight = 110
        x_velocity_reward_weight = 70
        y_velocity_reward_weight = 70
        angle_reward_weight = 110
        # td_reward_weight = 1  # weight of temporal difference term

        # Compute shaping reward based on current state
        ...
        shaping_reward = x_position_reward + y_position_reward + x_velocity_reward + y_velocity_reward + angle_reward

        # # Compute temporal difference reward based on previous and current shapings
        # if self.prev_shaping is not None:
        #     td_reward = td_reward_weight * (shaping_reward - self.prev_shaping)
        # else:
        #     td_reward = 0
        #
        # # Combine shaping and temporal difference rewards
        # reward = shaping_reward + td_reward + extra_reward
