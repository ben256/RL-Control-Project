from helpers.reward_machines.reward_functions import *
from helpers.reward_machines.reward_machine_utils import evaluate_dnf, value_iteration
import time
...
class RewardMachine:
    ...
    def step(self, u1, true_props, s_info, add_rs=False, env_done=False):
        ...
        # Getting the reward
        reward = self._get_reward(u1, u2, s_info, add_rs, env_done)
